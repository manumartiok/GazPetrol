...
@section('content')
 ...
 {{-- cabezal  --}}
    <div>
        <h3 class="text-[20px] font-bold text-gray-500">Institucional</h3>
        <hr class="mx-6">
    </div>
    {{-- Editor --}}
   <div class="p-4">
        <div class="overflow-x-auto rounded-2xl shadow">
            ...
            <tbody id="galeria-fotos" class="text-gray-600">
                ...
                <tr class="border-t hover:bg-gray-50 cursor-move" data-id="{{$institucional->id}}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            activarOrdenDragDrop('#galeria-fotos', '{{ route('adm.institucional-reordenar') }}');
        });
</script>
@endsection