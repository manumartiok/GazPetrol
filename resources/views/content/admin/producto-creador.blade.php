   ...
   {{-- cabezal --}}
    ...
    <div class="mx-20 pt-6" id="app">
        <div class="border border-rounded p-4">
            <div>
                <h3 class="text-[18px] font-semibold  text-gray-600">Crear producto</h3>
            </div>
            <hr class="my-3">
            ...
            <form method="POST" action="{{ route('adm.productos-store') }}" enctype="multipart/form-data" @submit.prevent="handleSubmit"> 
                ...
                <div>
                    ...
                    <input type="file" name="foto_producto" id="foto_producto" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required/>
                    </div>
