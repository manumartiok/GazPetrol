   ...
   {{-- cabezal --}}
    ...
    <div class="mx-20 pt-6" id="app">
        <div class="border border-rounded p-4">
            <div>
                <h3 class="text-[18px] font-semibold  text-gray-600">Crear categoria</h3>
            </div>
            <hr class="my-3">
            
            <form method="POST" action="{{ route('adm.categorias-store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2" for="categoria">Categorias</label>
                        <input type="text" id="categoria" name="categoria" placeholder="Categorias" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
