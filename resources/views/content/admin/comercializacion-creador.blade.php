...
@section('content')
   ...
   {{-- cabezal --}}
    <div>
        <h3 class="text-[20px] font-bold text-gray-500">Crear contenido comercializacion</h3>
        <hr class="mx-6">
    </div>
    ...
    <div class="mx-20 pt-6" id="app">
        <div class="border border-rounded p-4">
            ...
            <form method="POST" action="{{ route('adm.comercializacion-store') }}" enctype="multipart/form-data" @submit.prevent="handleSubmit">
                ...
                <div>
                    <div class="mb-4">
                    <label class="block text-gray-700 font-medium mb-2" for="foto">Foto (recomendado 600x400) / (2MB tamaño máximo)</label>
