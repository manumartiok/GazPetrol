...
@section('content')
   ...
   {{-- cabezal --}}
    <div>
        <h3 class="text-[20px] font-bold text-gray-500">Editar banner Nosotros</h3>
        <hr class="mx-6">
    </div>
            ...
            <form method="POST" action="{{ route('adm.nosotros-ban-update') }}" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    @if (!empty($nosotro_banners->foto))
                        <img :src="foto.foto || '{{ $nosotro_banners->foto }}'" alt="Foto"  class="mb-3 w-full max-w-[1366px] h-[450px] object-cover">
                    @endif
